...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-body">
            <form action="{{route('pos.tma.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            <label for="" class="mb-2">Nama</label>
                            <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{old('nama')}}" placeholder="Masukan Nama...">
                            @error('nama')
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="koordinatx" id="koordinatx" value="{{old('koordinatx')}}" class="form-control @error('koordinatx') is-invalid @enderror" placeholder="Masukan Koordinat X...">
                            @error('koordinatx')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="koordinaty" id="koordinaty" value="{{old('koordinaty')}}" class="form-control @error('koordinaty') is-invalid @enderror" placeholder="Masukan Koordinat Y...">
                            @error('koordinaty')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea name="lokasi" id="lokasi" class="form-control @error('lokasi') is-invalid @enderror" cols="30" rows="10" placeholder="Masukan Lokasi...">{{old('lokasi')}}</textarea>
                            @error('lokasi')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group mb-3">
                            ...
                            @else
                                ...
                                <input type="text" name="normal" id="normal" value="{{old('normal')}}" class="form-control @error('normal') is-invalid @enderror">
                            @endif
                            @error('normal')
                                <span class="invalid-feedback">
                                    {{$message}}
                    ...
                    <div class="col-lg-3">
                        <div class="form-group mb-3">
                            ...
                            @else
                                ...
                                <input type="text" name="waspada" id="waspada" value="{{old('waspada')}}" class="form-control @error('waspada') is-invalid @enderror">
                            @endif
                            @error('waspada')
                                <span class="invalid-feedback">
                                    {{$message}}
                    ...
                    <div class="col-lg-3">
                        <div class="form-group mb-3">
                            ...
                            @else
                                ...
                                <input type="text" name="siaga" id="siaga" value="{{old('siaga')}}" class="form-control @error('siaga') is-invalid @enderror">
                            @endif
                            @error('siaga')
                                <span class="invalid-feedback">
                                    {{$message}}
                    ...
                    <div class="col-lg-3">
                        <div class="form-group mb-3">
                            ...
                            @else
                                ...
                                <input type="text" name="awas" id="awas" value="{{old('awas')}}" class="form-control @error('awas') is-invalid @enderror">
                            @endif
                            @error('awas')
                                <span class="invalid-feedback">
                                    {{$message}}
                    ...
                    <div class="col-lg-12">
                        <div class="form-group mb-3">
                            ...
                            @endif
                            <input type="text" name="tma_banjir" id="tma_banjir" value="{{old('tma_banjir')}}" class="form-control @error('tma_banjir') is-invalid @enderror">
                            @error('tma_banjir')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="file" name="gambar" id="gambar" value="{{old('gambar')}}" class="form-control @error('gambar') is-invalid @enderror" placeholder="Masukan gambar ...">
                            @error('gambar')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
