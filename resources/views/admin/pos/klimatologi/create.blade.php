...
@section('title')
    Tambah Data Klimatologi ({{$pos->nama}})
@endsection
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{route('pos.klimatologi.show', ['id' => $pos->id])}}" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
        <div class="card-body">
            <form class="mt-4" action="{{route('pos.klimatologi.storeKlimatologi')}}" method="POST">
                @csrf
