...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{asset('batch/batch_input_crhs.xlsx')}}" class="btn btn-outline-success"><i class="fas fa-file-excel"></i> Download Template</a>
        </div>
        <div class="card-body">
            <form action="{{route('batch.importCRH')}}" method="POST" enctype="multipart/form-data">
                @csrf
