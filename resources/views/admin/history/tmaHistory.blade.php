    ...
    <div class="card mt-3">
        <div class="card-body">
            @if (!empty($start_date) && !empty($end_date))
                <h5 class="mb-3 text-center">Data Yang Melewati Batas Pos Tinggi Muka Air Bulan {{\Carbon\Carbon::parse($start_date)->format('m')}} Tahun {{\Carbon\Carbon::parse($start_date)->format('Y')}}</h5>
            @else
                <h5 class="mb-3 text-center">Data Yang Melewati Batas Pos Tinggi Muka Air Bulan {{\Carbon\Carbon::now()->format('m')}} Tahun {{\Carbon\Carbon::now()->format('Y')}}</h5>
            @endif
            <hr class="divide">
            <table class="table table-bordered table-striped table-hover text-center">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8">Tidak Ada Data Di Bulan Ini</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
