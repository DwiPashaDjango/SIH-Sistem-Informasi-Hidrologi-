                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data.data, function(index, value) {
                            ...
                            if (value.hujan_biasa >= value.hujan_otomatis) {
                                cardText = 'Hujan Biasa';
                            } else if(value.hujan_otomatis >= value.hujan_biasa) {
                                cardText = 'Hujan Otomatis';
                            } else {
                                cardText = 'Hujan Biasa';
                            }
                                        ...
                                        <div class="p-4 show-detail d-none">
                                            <div>
                                                ...
                                                <div class="mt-2 row">
                                                    ...
                                                    <div class="col" style="background-color: rgb(228, 208, 10); height: 20px;"></div>
                                                    <div class="col" style="background-color: rgb(255, 140, 0); height: 20px;"></div>
                                                    <div class="col" style="background-color: rgb(255, 87, 51); height: 20px;"></div>
                                                </div>
                                                <div class="mt-2 row">
                                                    <div class="col-md-3">${value.normal} mm</div>
                                                    <div class="col-md-3">${value.waspada} mm</div>
                                                    <div class="col-md-3">${value.siaga} mm</div>
                                                    <div class="col-md-3">${value.awas} mm</div>
                                                </div>
                                            </div>
                                        </div>
                                    </li>`;
            ...
            function getGeoJsonmarker(data) {
                ...
                let geojson = {
                    ...
                    "features": data.data.map(marker => {
                        ...
                        if (marker.hujan_biasa >= marker.hujan_otomatis) {
                            textCard = 'Hujan Biasa';
                        } else if(marker.hujan_otomatis >= marker.hujan_biasa) {
                            textCard = 'Hujan Otomatis';
                        } else {
                            textCard = 'Hujan Biasa';
                        }
                                                ...
                                                <div class="leaflet-popup-content" style="width: 350px;">
                                                    <div class="p-3 row">
                                                        <div class="col">
                                                            ...
                                                            <p>Kabupaten : <strong>${marker.regencie}</strong></p>
                                                            <p>Provinsi : <strong>${marker.province}</strong></p>
                                                            <p>Koordinat : <strong>${marker.koordinatx}, ${marker.koordinaty}</strong></p>
                                                            <p>Status : <strong>${marker.status}</strong></p>
                                                        </div>
                                                        <div class="col">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="mt-2 row">
                                                                        <div class="col-md-3">${marker.normal} mm</div>
                                                                        <div class="col-md-3">${marker.waspada} mm</div>
                                                                        <div class="col-md-3">${marker.siaga} mm</div>
                                                                        <div class="col-md-3">${marker.awas} mm</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr class="divide">
                                                        <a class="btn" style="background-color: rgb(10, 71, 147); color: #fff" href="{{url('curah-hujan/${marker.id}/show')}}">Lihat Data Selengkapnya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        <div>
