                                        ...
                                        <div class="p-4 show-detail d-none">
                                            <div>
                                                <div class="mt-2 p-1" style="background-color: ${bgStatus};">
                                                    <h6><strong>TMA : ${value.nilai} cm</strong></h6>
                                                </div>
                                                <div class="mt-2 row">
                                                ...
                                                <div class="mt-2 row">
                                                    <div class="col-md-3">${value.normal} cm</div>
                                                    <div class="col-md-3">${value.waspada} cm</div>
                                                    <div class="col-md-3">${value.siaga} cm</div>
                                                    <div class="col-md-3">${value.awas} cm</div>
                                                </div>
                                            </div>
                                        </div>
                                    </li>`;
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <div>
                                                                <div class="mt-2 p-1" style="${statusColor}">
                                                                    <h6><strong>TMA : ${marker.nilai} cm</strong></h6>
                                                                </div>
                                                                <div>
                                                                    <div class="mt-2 row">
                                                                        <div class="col" style="background-color: rgb(80, 200, 120); height: 20px;"></div>
                                                                    ...
                                                                    <div class="mt-2 row">
                                                                        <div class="col-md-3">${marker.normal} cm</div>
                                                                        <div class="col-md-3">${marker.waspada} cm</div>
                                                                        <div class="col-md-3">${marker.siaga} cm</div>
                                                                        <div class="col-md-3">${marker.awas} cm</div>
                                                                    </div>
                                                                    <div class="mt-3 row">
                                                                        <div class="col">Pagi</div>
                                                                        <div class="col">Siang</div>
                                                                        <div class="col">Sore</div>
                                                                    </div>
                                                                    <div class="mt-3 mb-3 row">
                                                                        <div class="col-md-4">${marker.pagi} cm</div>
                                                                        <div class="col-md-4">${marker.siang} cm</div>
                                                                        <div class="col-md-4">${marker.sore} cm</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr class="divide">
                                                        <a class="btn" style="background-color: rgb(10, 71, 147); color: #fff" href="{{url('pos/${marker.id}')}}">Lihat Data Selengkapnya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        <div>
